...
async function checkActiveProgress(paiDir: string): Promise<string | null> {
  ...
  summary += '\n💡 To resume project: `bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/SessionProgress.ts resume <project>`\n';
  summary += '💡 To complete project: `bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/SessionProgress.ts complete <project>`\n';
...
async function main() {
  try {
    ...
    if (needsRebuild) {
      ...
      try {
        execSync('bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/RebuildPAI.ts', {
          cwd: paiDir,
          stdio: 'pipe',
          timeout: 5000
        });
