...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/fabric/Patterns/`
...
```bash
/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/fabric/update-patterns.sh
```
...
All templates live in `/home/postnl/PAI_Codex/Codex_PAI/skills/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun /home/postnl/PAI_Codex/Codex_PAI/skills/Prompting/Tools/RenderTemplate.ts \
...
**Programmatic Usage:**
```typescript
import { renderTemplate } from '/home/postnl/PAI_Codex/Codex_PAI/skills/Prompting/Tools/RenderTemplate.ts';
