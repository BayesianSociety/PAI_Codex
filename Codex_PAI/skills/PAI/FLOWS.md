...
Local flow definitions are tracked in `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/FLOWS/flow-index.json`:
...
Flow state (run history, errors) is tracked in `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/flow-state.json`.
...
- **Actions:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/ACTIONS.md` *(planned)*
- **Pipelines:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/PIPELINES.md`
- **Architecture:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/PAISYSTEMARCHITECTURE.md`
- **Detailed README:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/FLOWS/README.md`
