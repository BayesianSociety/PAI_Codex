...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/Inference.ts`
...
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/Inference.ts --level fast "System prompt" "User prompt"

# Standard (Sonnet) - balanced reasoning, typical analysis
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/Inference.ts --level standard "System prompt" "User prompt"

# Smart (Opus) - deep reasoning, strategic decisions
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/Inference.ts --level smart "System prompt" "User prompt"

# With JSON output
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/Inference.ts --json --level fast "Return JSON" "Input"

# Custom timeout
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/Inference.ts --level standard --timeout 60000 "Prompt" "Input"
```
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/RemoveBg.ts`
...
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/RemoveBg.ts /path/to/image.png

# Remove background and save to different path
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/RemoveBg.ts /path/to/input.png /path/to/output.png

# Process multiple images
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/RemoveBg.ts image1.png image2.png image3.png
```
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/AddBg.ts`
...
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/AddBg.ts /path/to/transparent.png "#EAE9DF" /path/to/output.png

# Add UL brand background color
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/AddBg.ts /path/to/transparent.png --ul-brand /path/to/output.png
```
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/GetTranscript.ts`
...
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=VIDEO_ID"

# Save transcript to file
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=VIDEO_ID" --save /path/to/transcript.txt
```
...
**Technical Details:**
- Voice server must be running (`/home/postnl/PAI_Codex/Codex_PAI/skills/VoiceServer/`)
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/extract-transcript.py`
...
cd /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/YouTubeApi.ts`
...
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/YouTubeApi.ts --channel-stats

# Get video statistics
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/YouTubeApi.ts --video-stats VIDEO_ID

# Get latest uploads
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/YouTubeApi.ts --latest-videos
```
...
1. **Add tool file:** Place `.ts` or `.py` file directly in `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/`
...
2. **Document here:** Add section to this file with:
   - Tool location (e.g., `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/ToolName.ts`)
   - Usage examples
