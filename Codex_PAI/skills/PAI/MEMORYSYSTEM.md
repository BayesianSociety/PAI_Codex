...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/`
...
```
/home/postnl/PAI_Codex/Codex_PAI/MEMORY/
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/projects/-Users-{username}--claude/`
...
ls /home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/ | tail -5
```

### Check ratings
```bash
tail /home/postnl/PAI_Codex/Codex_PAI/MEMORY/LEARNING/SIGNALS/ratings.jsonl
```
...
ls -lt /home/postnl/PAI_Codex/Codex_PAI/projects/-Users-{username}--claude/*.jsonl | head -5

# View last session events
tail /home/postnl/PAI_Codex/Codex_PAI/projects/-Users-{username}--claude/$(ls -t /home/postnl/PAI_Codex/Codex_PAI/projects/-Users-{username}--claude/*.jsonl | head -1) | jq .
```

### Check learnings
```bash
ls /home/postnl/PAI_Codex/Codex_PAI/MEMORY/LEARNING/SYSTEM/
ls /home/postnl/PAI_Codex/Codex_PAI/MEMORY/LEARNING/ALGORITHM/
ls /home/postnl/PAI_Codex/Codex_PAI/MEMORY/LEARNING/SYNTHESIS/
```

### Check failures
```bash
# List recent failure captures
ls -lt /home/postnl/PAI_Codex/Codex_PAI/MEMORY/LEARNING/FAILURES/$(date +%Y-%m)/ 2>/dev/null | head -10

# View a specific failure
cat /home/postnl/PAI_Codex/Codex_PAI/MEMORY/LEARNING/FAILURES/2026-01/*/CONTEXT.md | head -100

# Migrate historical low ratings to FAILURES
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/FailureCapture.ts --migrate
```

### Check multi-session progress
```bash
ls /home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/progress/
```

### Run harvesting tools
```bash
# Harvest learnings from recent sessions
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/SessionHarvester.ts --recent 10

# Generate pattern synthesis
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/LearningPatternSynthesis.ts --week
```
...
- Moved BACKUPS to `/home/postnl/PAI_Codex/Codex_PAI/BACKUPS/` (outside MEMORY)
- Renamed RAW-OUTPUTS to RAW
- All directories now ALL CAPS

**2026-01-05:** v1.0 - Unified Memory System migration
- Previous: `/home/postnl/PAI_Codex/Codex_PAI/history/`, `/home/postnl/PAI_Codex/Codex_PAI/context/`, `/home/postnl/PAI_Codex/Codex_PAI/progress/`
- Current: `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/`
