...
| **Skills** (`/home/postnl/PAI_Codex/Codex_PAI/skills/skill-index.json`) | Pre-made sub-algorithms for specific domains | When task matches skill trigger |
...
| **Researcher Agents** (`/home/postnl/PAI_Codex/Codex_PAI/skills/Research/SKILL.md`) | High-quality research via Research skill | External information needed |
...
| **Red Team** (`/home/postnl/PAI_Codex/Codex_PAI/skills/RedTeam/SKILL.md`) | Adversarial thinking, failure modes | High-stakes, need anti-criteria |
| **First Principles** (`/home/postnl/PAI_Codex/Codex_PAI/skills/FirstPrinciples/SKILL.md`) | Fundamental analysis without assumptions | Complex problems, unclear root cause |
| **Be Creative** (`/home/postnl/PAI_Codex/Codex_PAI/skills/BeCreative/SKILL.md`) | Expanded creativity mode | Novel solutions required |
