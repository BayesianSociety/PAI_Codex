...
| **Custom Agents** (`/home/postnl/PAI_Codex/Codex_PAI/skills/Agents/SKILL.md`) | ComposeAgent creates unique agents with custom names, voices, colors. Use `general-purpose` subagent, NOT static types (Intern/Architect/Engineer) | When user says "custom agents" - unique identities required |
