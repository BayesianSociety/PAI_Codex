...
📄 **PRD CREATION:**
[Create PRD at /home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/{session-slug}/PRD-{YYYYMMDD}-{slug}.md]
...
**Location:** Project `.prd/` if inside `.git/`, else `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/{session-slug}/`
