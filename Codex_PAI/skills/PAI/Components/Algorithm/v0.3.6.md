...
📄 **PRD CREATION:**
[Create PRD file at /home/postnl/PAI_Codex/Codex_PAI/plans/PRD-{YYYYMMDD}-{slug}.md or project .prd/ directory]
...
**Location:** Project `.prd/` directory if inside a project with `.git/`, else `/home/postnl/PAI_Codex/Codex_PAI/plans/`
...
| 4 | **Skills** (69+ in index) | Domain-specific sub-algorithms | `/home/postnl/PAI_Codex/Codex_PAI/skills/skill-index.json` |
