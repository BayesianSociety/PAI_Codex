...
| **Researcher Agents** (`/home/postnl/PAI_Codex/Codex_PAI/skills/Research/SKILL.md`) | High-quality research via Research skill. Use instead of fetch for research. | Information gathering |
