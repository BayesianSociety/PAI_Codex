...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts`
...
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts -m loop -p <PRD-path> -n 20

# Run in interactive mode (launches a claude session with PRD context)
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts -m interactive -p <PRD-path>

# Check status of all PRDs
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts status
```
...
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts -m loop -p PRD-20260213-auth.md

# Fast loop — 20 max iterations
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts -m loop -p PRD-20260213-auth.md -n 20

# Parallel loop — 4 agents working on different criteria simultaneously
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts -m loop -p PRD-20260213-auth.md -n 20 -a 4
```
...
```bash
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts -m interactive -p PRD-20260213-feature.md
```
...
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts status -p PRD-20260213-auth

# Pause a running loop (loop checks between iterations)
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts pause -p PRD-20260213-auth

# Resume a paused loop
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts resume -p PRD-20260213-auth

# Stop a loop permanently
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts stop -p PRD-20260213-auth
```
...
|--------|---------|------------|
| Full path | `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/auth/PRD-20260207-auth.md` | Used directly |
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/ACTIONS/pai.ts`
...
```bash
cd /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/ACTIONS
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/ACTIONS/lib/runner.v2.ts`
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/ACTIONS/lib/pipeline-runner.ts`
...
```bash
# The Algorithm CLI
alias algorithm="bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/algorithm.ts"

# The Arbol CLI
alias pai="bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/ACTIONS/pai.ts"

# Runners (optional — pai CLI wraps these)
alias arbol-run="bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/ACTIONS/lib/runner.v2.ts"
alias arbol-pipe="bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/ACTIONS/lib/pipeline-runner.ts"
```
