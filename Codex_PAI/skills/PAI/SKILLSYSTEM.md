...
- Reference `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/` for any personalization
...
```bash
ls -1 /home/postnl/PAI_Codex/Codex_PAI/skills/ | grep "^_"
```
...
- `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/CONTACTS.md` - Contact information
- `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TECHSTACKPREFERENCES.md` - Tech preferences
```
...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/{SkillName}/`
...
```
/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/
...
1. **Create directory**: `mkdir -p /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/SkillName`
...
**See:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Science/Protocol.md` for the full protocol interface
...
**Full documentation:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/THENOTIFICATIONSYSTEM.md`
...
Read /home/postnl/PAI_Codex/Codex_PAI/skills/Art/Aesthetic.md
```
...
```
/home/postnl/PAI_Codex/Codex_PAI/skills/Createskill/Workflows/CanonicalizeSkill.md
```
...
5. Move backups to `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/Backups/`
...
**Reference:** `/home/postnl/PAI_Codex/Codex_PAI/skills/_YOURSKILL/SKILL.md`
...
**See:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/CLIFIRSTARCHITECTURE.md` (Workflow-to-Tool Integration section)
...
**See:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/CLIFIRSTARCHITECTURE.md` (Configuration Flags section) for full documentation
 ...
 *
 * Usage:
 *   bun /home/postnl/PAI_Codex/Codex_PAI/skills/SkillName/Tools/ToolName.ts <command> [options]
 *
 * Commands:
