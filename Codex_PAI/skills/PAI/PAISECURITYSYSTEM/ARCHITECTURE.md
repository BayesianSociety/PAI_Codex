...
HIGH TRUST:    PAI skill files and agent configs
               ↓
MEDIUM TRUST:  Verified code in /home/postnl/PAI_Codex/Codex_PAI/
               ↓
...
**Security events are logged as individual files:** `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/SECURITY/YYYY/MM/security-{summary}-{timestamp}.jsonl`
