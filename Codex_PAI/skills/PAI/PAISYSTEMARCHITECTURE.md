...
```
PRIVATE: /home/postnl/PAI_Codex/Codex_PAI/                    PUBLIC: ${PROJECTS_DIR}/PAI/
...
|----------|-------------|----------|
| **Integrity Audits** | Verify broken references across /home/postnl/PAI_Codex/Codex_PAI | System integrity workflows |
