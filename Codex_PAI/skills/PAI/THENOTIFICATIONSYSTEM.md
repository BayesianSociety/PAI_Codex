...
**Full voice registry:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Agents/SKILL.md` (see Named Agents and voice configuration)
...
Located in `/home/postnl/PAI_Codex/Codex_PAI/settings.json`:
...
The notification service is in `/home/postnl/PAI_Codex/Codex_PAI/hooks/lib/notifications.ts`:
