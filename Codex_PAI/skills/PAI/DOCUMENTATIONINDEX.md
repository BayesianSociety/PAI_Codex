...
**All documentation files are in `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/` with SYSTEM/ and USER/ subdirectories. Read these files when you need deeper context.**
...
**Agent System:**
- **Agents Skill** (`/home/postnl/PAI_Codex/Codex_PAI/skills/Agents/`) - Complete agent composition system | See Agents skill for custom agent creation, traits, and voice mappings
