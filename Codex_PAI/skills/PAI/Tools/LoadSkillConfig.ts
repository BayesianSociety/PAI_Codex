 ...
 *
 * Usage:
 *   import { loadSkillConfig } from '/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/LoadSkillConfig';
 *   const config = loadSkillConfig<MyConfigType>(__dirname, 'config.json');
 *
 * Or CLI:
 *   bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/LoadSkillConfig.ts <skill-dir> <filename>
 */
...
Examples:
  bun LoadSkillConfig.ts /home/postnl/PAI_Codex/Codex_PAI/skills/PAIUpgrade sources.json
