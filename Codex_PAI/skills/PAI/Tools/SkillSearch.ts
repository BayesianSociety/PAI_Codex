 ...
 *
 * Usage:
 *   bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/SkillSearch.ts <query>
 *   bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/SkillSearch.ts "scrape instagram"
 *   bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/SkillSearch.ts --list           # List all skills
 *   bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/SkillSearch.ts --tier always    # List always-loaded skills
 *   bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/SkillSearch.ts --tier deferred  # List deferred skills
 *
...
async function main() {
  ...
  if (!existsSync(INDEX_FILE)) {
    ...
    console.error('   bun run /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/GenerateSkillIndex.ts');
    process.exit(1);
  }
