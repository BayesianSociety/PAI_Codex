...
**Primary Skill:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Fabric/SKILL.md`
...
**Patterns Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Fabric/Patterns/` (237 patterns)
...
-> Runs fabric -U
-> Syncs to /home/postnl/PAI_Codex/Codex_PAI/skills/Fabric/Patterns/
```

**Manual:**
```bash
fabric -U && rsync -av ~/.config/fabric/patterns/ /home/postnl/PAI_Codex/Codex_PAI/skills/Fabric/Patterns/
```
...
- **Full Skill:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Fabric/SKILL.md`
- **Pattern Execution:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Fabric/Workflows/ExecutePattern.md`
- **Pattern Updates:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Fabric/Workflows/UpdatePatterns.md`
- **All Patterns:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Fabric/Patterns/`
