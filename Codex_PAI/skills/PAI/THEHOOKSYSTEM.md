...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/hooks/`
**Configuration:** `/home/postnl/PAI_Codex/Codex_PAI/settings.json`
...
- **History Capture** - Automatic work/learning documentation to `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/`
...
- Writes to `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/SIGNALS/ratings.jsonl`
...
### Location
**File:** `/home/postnl/PAI_Codex/Codex_PAI/settings.json`
**Section:** `"hooks": { ... }`

### Environment Variables
Hooks have access to all environment variables from `/home/postnl/PAI_Codex/Codex_PAI/settings.json` `"env"` section:
...
**Key Variables:**
- `PAI_DIR` - PAI installation directory (typically `/home/postnl/PAI_Codex/Codex_PAI`)
...
**Session Mapping:** `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/agent-sessions.json`
```json
{
...
**Full Documentation:** See `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/TERMINALTABS.md`
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/hooks/my-custom-hook.ts`
...
```bash
chmod +x /home/postnl/PAI_Codex/Codex_PAI/hooks/my-custom-hook.ts
```
...
```bash
# Test hook directly
echo '{"session_id":"test","transcript_path":"/tmp/test.jsonl","hook_event_name":"Stop"}' | bun /home/postnl/PAI_Codex/Codex_PAI/hooks/my-custom-hook.ts
```
...
**Check:**
1. Is hook script executable? `chmod +x /home/postnl/PAI_Codex/Codex_PAI/hooks/my-hook.ts`
2. Is path correct in settings.json? Use `${PAI_DIR}/hooks/...`
3. Is settings.json valid JSON? `jq . /home/postnl/PAI_Codex/Codex_PAI/settings.json`
4. Did you restart Claude Code after editing settings.json?

**Debug:**
```bash
# Test hook directly
echo '{"session_id":"test","transcript_path":"/tmp/test.jsonl","hook_event_name":"Stop"}' | bun /home/postnl/PAI_Codex/Codex_PAI/hooks/my-hook.ts

# Check hook logs (stderr output)
tail -f /home/postnl/PAI_Codex/Codex_PAI/hooks/debug.log  # If you add logging
```
...
**Check:**
1. Does `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/` directory exist?
2. Is AutoWorkCreation hook running? Check `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/current-work.json`
3. Is hook actually running? Check `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/RAW/` for events
4. File permissions? `ls -la /home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/`

**Debug:**
```bash
# Check current work
cat /home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/current-work.json

# Check recent work directories
ls -lt /home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/ | head -10
ls -lt /home/postnl/PAI_Codex/Codex_PAI/MEMORY/LEARNING/$(date +%Y-%m)/ | head -10

# Check raw events
tail /home/postnl/PAI_Codex/Codex_PAI/MEMORY/RAW/$(date +%Y-%m)/$(date +%Y-%m-%d)_all-events.jsonl
```
...
**Check:**
1. Is `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/agent-sessions.json` writable?
...
cat /home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/agent-sessions.json | jq .

# Check subagent-stop debug log
tail -f /home/postnl/PAI_Codex/Codex_PAI/hooks/subagent-stop-debug.log
```
...
grep '"type":"user"' /home/postnl/PAI_Codex/Codex_PAI/projects/-Users-yourname--claude/*.jsonl | head -1 | jq '.type'
...
**Check:**
1. Does `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/SKILL.md` exist?
...
bun /home/postnl/PAI_Codex/Codex_PAI/hooks/LoadContext.hook.ts
...
- Permission denied → `chmod +x /home/postnl/PAI_Codex/Codex_PAI/hooks/LoadContext.hook.ts`
...
- **Voice System:** `/home/postnl/PAI_Codex/Codex_PAI/VoiceServer/SKILL.md`
- **Agent System:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Agents/SKILL.md`
- **History/Memory:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/MEMORYSYSTEM.md`
...
/home/postnl/PAI_Codex/Codex_PAI/hooks/                     Hook scripts (20 files)
/home/postnl/PAI_Codex/Codex_PAI/hooks/handlers/            Stop handler modules (5 files)
/home/postnl/PAI_Codex/Codex_PAI/hooks/lib/identity.ts      Identity loader
/home/postnl/PAI_Codex/Codex_PAI/hooks/lib/learning-utils.ts Learning categorization
/home/postnl/PAI_Codex/Codex_PAI/hooks/lib/time.ts          PST timestamp utilities
/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/               Work tracking
/home/postnl/PAI_Codex/Codex_PAI/MEMORY/LEARNING/           Learning captures
/home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/              Runtime state

INFERENCE TOOL (for hooks needing AI):
Path: /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/Inference.ts
