...
import { insertNewsletterContent } from '/home/postnl/PAI_Codex/Codex_PAI/skills/parser/db';
...
- For traditional PDF extraction (text-only), see `/home/postnl/PAI_Codex/Codex_PAI/skills/documents/pdf/SKILL.md`
- For PDF form filling, see `/home/postnl/PAI_Codex/Codex_PAI/skills/documents/pdf/forms.md`
- For parser integration, see `/home/postnl/PAI_Codex/Codex_PAI/skills/parser/SKILL.md`
- For newsletter database schema, see `/home/postnl/PAI_Codex/Codex_PAI/Context/databases/newsletter/schema.sql`
