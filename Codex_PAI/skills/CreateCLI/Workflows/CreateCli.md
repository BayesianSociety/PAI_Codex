...
**Reference:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/CliFirstArchitecture.md` (Configuration Flags section)
...
For more information, see /home/postnl/PAI_Codex/Codex_PAI/Bin/{{CLI_NAME}}/README.md
...
See: /home/postnl/PAI_Codex/Codex_PAI/Bin/{{CLI_NAME}}/README.md
```
...
**Validation Commands:**
```bash
cd /home/postnl/PAI_Codex/Codex_PAI/Bin/{{CLI_NAME}}/
chmod +x {{CLI_NAME}}.ts
./{{CLI_NAME}}.ts --help
./{{CLI_NAME}}.ts --version
```
...
**Report to user:**
```
✅ CLI Created: /home/postnl/PAI_Codex/Codex_PAI/Bin/{{CLI_NAME}}/
...
Documentation: /home/postnl/PAI_Codex/Codex_PAI/Bin/{{CLI_NAME}}/README.md
```
...
**Generated Output:**
```
✅ CLI Created: /home/postnl/PAI_Codex/Codex_PAI/Bin/notioncli/
...
3. Read: /home/postnl/PAI_Codex/Codex_PAI/Bin/notioncli/README.md
...
Use proven structure from /home/postnl/PAI_Codex/Codex_PAI/Bin/llcli/ as reference.
