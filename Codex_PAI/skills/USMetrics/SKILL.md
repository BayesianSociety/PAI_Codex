...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/USMetrics/`
...
**Execution:**
```bash
bun /home/postnl/PAI_Codex/Codex_PAI/skills/USMetrics/Tools/update-substrate-metrics.ts
```
