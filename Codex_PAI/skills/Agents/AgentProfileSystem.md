...
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Tools/LoadAgentContext.ts Architect "Design new skill system"
```
...
1. Create `[AgentType]Context.md` in `/home/postnl/PAI_Codex/Codex_PAI/skills/Agents/`
