 ...
 *
 * Configuration files:
 *   Base:  /home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Data/Traits.yaml
 *   User:  /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml
 *
 * Usage:
...
/**
 * Save a composed agent to /home/postnl/PAI_Codex/Codex_PAI/custom-agents/{slug}.md
 *
 * Produces a CLAUDE CODE COMPATIBLE agent file that can be:
 * 1. Copied to /home/postnl/PAI_Codex/Codex_PAI/agents/ and used as a built-in agent
 ...
 *
 * Matches the structural format of built-in agents in /home/postnl/PAI_Codex/Codex_PAI/agents/*.md:
...
\`\`\`bash
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Tools/ComposeAgent.ts --load "${slug}"
\`\`\`

Or reconstruct from traits:

\`\`\`bash
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Tools/ComposeAgent.ts --traits "${agent.traits.join(",")}"
\`\`\`
...
OPTIONS:
  ...
  -s, --save           Save composed agent to /home/postnl/PAI_Codex/Codex_PAI/custom-agents/
...
CONFIGURATION:
  Base traits:    /home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Data/Traits.yaml
  User traits:    /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml
  Custom agents:  /home/postnl/PAI_Codex/Codex_PAI/custom-agents/
