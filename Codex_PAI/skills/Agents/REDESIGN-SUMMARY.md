...
```
/home/postnl/PAI_Codex/Codex_PAI/skills/Agents/
...
Old YAML system backed up to: `/home/postnl/PAI_Codex/Codex_PAI/History/Backups/2025-12-18-AgentProfiles/`
...
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Tools/LoadAgentContext.ts
# Output: Architect, Artist, Engineer, Designer, QATester

# View specific context
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Tools/LoadAgentContext.ts Architect

# Generate enriched prompt
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Tools/LoadAgentContext.ts Engineer "Implement TDD workflow"
```
