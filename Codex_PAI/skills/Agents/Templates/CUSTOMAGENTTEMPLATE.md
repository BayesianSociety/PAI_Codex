...
- **Built-in agents** (`/home/postnl/PAI_Codex/Codex_PAI/agents/*.md`): Use this format for the persona section
- **Custom agents** (`/home/postnl/PAI_Codex/Codex_PAI/custom-agents/*.md`): Use this format for the entire file
...
|--------|-------------------------|-------------------------------|
| Location | `/home/postnl/PAI_Codex/Codex_PAI/agents/` | `/home/postnl/PAI_Codex/Codex_PAI/custom-agents/` |
