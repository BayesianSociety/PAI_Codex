...
**What happens:**
1. Run `bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Tools/ComposeAgent.ts` for EACH agent
...
- Trait definitions: `/home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Data/Traits.yaml`
- Agent template: `/home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Templates/DynamicAgent.hbs`
- Composition tool: `/home/postnl/PAI_Codex/Codex_PAI/skills/Agents/Tools/ComposeAgent.ts`

---

## Named Agent Architecture

- **Location**: Individual agent files in `/home/postnl/PAI_Codex/Codex_PAI/agents/*.md`
