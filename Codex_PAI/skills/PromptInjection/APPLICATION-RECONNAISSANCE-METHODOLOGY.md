...
mkdir -p /home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/${WORK_DIR}/scratch/$(date +%Y-%m-%d-%H%M%S)_prompt-injection-test-TARGET/
cd /home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/${WORK_DIR}/scratch/$(date +%Y-%m-%d-%H%M%S)_prompt-injection-test-TARGET/
...
browser screenshot
cp "$(find /home/postnl/PAI_Codex/Codex_PAI/Plugins/marketplaces/browser-tools/agent/browser_screenshots -type f -name '*.png' | tail -1)" initial_page.png
...
browser screenshot
cp "$(find /home/postnl/PAI_Codex/Codex_PAI/Plugins/marketplaces/browser-tools/agent/browser_screenshots -type f -name '*.png' | tail -1)" final_page.png
