...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PromptInjection/COMPREHENSIVE-ATTACK-TAXONOMY.md` (Section 2)

**RAG security best practices:**
`/home/postnl/PAI_Codex/Codex_PAI/skills/PromptInjection/DEFENSE-MECHANISMS.md` (RAG Defense)
