...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PromptInjection/Workflows/Reconnaissance.md`
...
**Save to:**
```
/home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_[client]-recon/
...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PromptInjection/Workflows/DirectInjectionTesting.md`
...
```
/home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_[client]-direct-injection/
├── findings.md
...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PromptInjection/Workflows/IndirectInjectionTesting.md`
...
**Document findings in:**
```
/home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_[client]-indirect-injection/
├── findings.md
├── poisoned-documents/
├── test-web-pages/
...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PromptInjection/Workflows/MultiStageAttacks.md`
...
```
/home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_[client]-multistage/
...
**Document in:**
```
/home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_[client]-defenses/
...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PromptInjection/Reporting.md`
...
**Deliverables:**
```
/home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_[client]-final-report/
