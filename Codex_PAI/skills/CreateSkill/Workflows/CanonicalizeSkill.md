...
```bash
/home/postnl/PAI_Codex/Codex_PAI/skills/[skill-name]/SKILL.md
```
...
```bash
cp -r /home/postnl/PAI_Codex/Codex_PAI/skills/[skill-name]/ /home/postnl/PAI_Codex/Codex_PAI/History/Backups/[skill-name]-backup-$(date +%Y%m%d)/
```

**Note:** Backups go to `/home/postnl/PAI_Codex/Codex_PAI/History/Backups/`, NEVER inside skill directories.
...
cd /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/Workflows/
...
find /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/ -type d -mindepth 2 -maxdepth 3
```
