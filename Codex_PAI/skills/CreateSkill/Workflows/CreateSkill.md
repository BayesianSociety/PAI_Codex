...
1. Read the skill system documentation: `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/SkillSystem.md`
2. Read the canonical example: `/home/postnl/PAI_Codex/Codex_PAI/skills/ExampleSkill/SKILL.md`
...
```bash
mkdir -p /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/Workflows
mkdir -p /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/Tools
```

**Example:**
```bash
mkdir -p /home/postnl/PAI_Codex/Codex_PAI/skills/Daemon/Workflows
mkdir -p /home/postnl/PAI_Codex/Codex_PAI/skills/Daemon/Tools
```
...
```bash
touch /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/Workflows/[WorkflowName].md
```
...
**Reference:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/CliFirstArchitecture.md` (Workflow-to-Tool Integration section)

**Examples (TitleCase):**
```bash
touch /home/postnl/PAI_Codex/Codex_PAI/skills/Daemon/Workflows/UpdateDaemonInfo.md
touch /home/postnl/PAI_Codex/Codex_PAI/skills/Daemon/Workflows/UpdatePublicRepo.md
touch /home/postnl/PAI_Codex/Codex_PAI/skills/ExampleSkill/Workflows/Create.md
touch /home/postnl/PAI_Codex/Codex_PAI/skills/ExampleSkill/Workflows/Publish.md
```
...
Run this check:
```bash
ls /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/
ls /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/Workflows/
ls /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/Tools/
```
