...
### Skill Directory
```bash
ls /home/postnl/PAI_Codex/Codex_PAI/skills/ | grep -i [skillname]
```
...
```bash
ls -la /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/
```
...
```bash
bun /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/Tools/[ToolName].ts --help
```
...
```bash
grep -l "Intent-to-Flag" /home/postnl/PAI_Codex/Codex_PAI/skills/[SkillName]/Workflows/*.md
```
...
**Reference:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/CliFirstArchitecture.md`
