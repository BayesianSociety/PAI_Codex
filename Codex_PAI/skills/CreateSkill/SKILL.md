...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/CreateSkill/`
...
**Before creating ANY skill, READ:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/SkillSystem.md`

**Canonical example to follow:** `/home/postnl/PAI_Codex/Codex_PAI/skills/_YOURSKILL/SKILL.md`
...
**See:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/SkillSystem.md` (Flat Folder Structure section)
...
**See:** `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/SkillSystem.md` (Dynamic Loading Pattern section)
