...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/Recon/`
...
- `naabu` - Port scanning
- Note: Requires security MCP profile (`/home/postnl/PAI_Codex/Codex_PAI/MCPs/swap-mcp security`)
...
Reports saved to:
- **Work scratch/** (`/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/{current_work}/scratch/`) - For iterative artifacts during investigation
- **MEMORY/RESEARCH/** (`/home/postnl/PAI_Codex/Codex_PAI/MEMORY/RESEARCH/YYYY-MM/`) - For pentest engagements and formal assessments
...
/home/postnl/PAI_Codex/Codex_PAI/MCPs/swap-mcp security
...
Assistant: Activating recon skill with passive-recon workflow.
     ...
     Report: /home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/{current_work}/scratch/recon-example-com/
```
...
**Security Skills:**
- `/home/postnl/PAI_Codex/Codex_PAI/skills/OSINT/` - Entity and people reconnaissance
- `/home/postnl/PAI_Codex/Codex_PAI/skills/Webassessment/` - Web application testing
