...
SCAN_FILE=/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/${WORK_DIR}/scratch/$(date +%Y-%m-%d)_nmap-scan.txt

# Or masscan results
MASSCAN_FILE=/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/${WORK_DIR}/scratch/$(date +%Y-%m-%d)_masscan.json

# Or combined multi-tool archive from history
SCAN_DIR=/home/postnl/PAI_Codex/Codex_PAI/History/security/scans/2025-11-target-recon/
```
...
// Usage: bun run tools/batch-scan-analysis.ts /home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/{current_work}/scratch/target-scans/
```
