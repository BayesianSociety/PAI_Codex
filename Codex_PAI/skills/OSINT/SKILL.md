...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/OSINT/`
...
```
/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/$(jq -r '.work_dir' /home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/current-work.json)/scratch/YYYY-MM-DD-HHMMSS_osint-[target]/
```

**Archived reports:**
```
/home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM/[target]-osint/
```
