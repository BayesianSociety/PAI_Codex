...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/Evals/`
...
```bash
# Run an eval suite
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Tools/AlgorithmBridge.ts -s <suite>

# Log a failure for later conversion
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Tools/FailureToTask.ts log "description" -c category -s severity

# Convert failures to test tasks
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Tools/FailureToTask.ts convert-all

# Manage suites
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Tools/SuiteManager.ts create <name> -t capability -d "description"
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Tools/SuiteManager.ts list
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Tools/SuiteManager.ts check-saturation <name>
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Tools/SuiteManager.ts graduate <name>
```
...
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Tools/AlgorithmBridge.ts -s regression-core -r 3 -u
```
