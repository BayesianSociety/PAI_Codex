...
```bash
# Create new use case
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli.ts use-case create --name <name>

# List all use cases
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli.ts use-case list
...
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli.ts test-case add --use-case <name>

# List test cases for use case
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli.ts test-case list --use-case <name>
```
...
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli-run.ts --use-case <name> [--model <model>]
```
...
```
/home/postnl/PAI_Codex/Codex_PAI/skills/Evals/
├── UseCases/
│   └── <name>/
