...
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli.ts results \
  --use-case <name> \
  --latest
```
...
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli.ts report \
  --run-id <run-id> \
  --output /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Results/<use-case>/<run-id>/report.md
```
...
bun run /home/postnl/PAI_Codex/Codex_PAI/Templates/Tools/RenderTemplate.ts \
  -t Evals/Report.hbs \
  -d /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Results/<use-case>/<run-id>/results.yaml \
  -o /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/Results/<use-case>/<run-id>/report.md
```
...
```bash
cd /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer
...
```bash
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli.ts compare \
  --run-a <run-id-1> \
  --run-b <run-id-2>
```
...
```bash
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli.ts trend \
  --use-case <name> \
  --days 30
```
