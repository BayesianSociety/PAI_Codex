...
```bash
mkdir -p /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/UseCases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `/home/postnl/PAI_Codex/Codex_PAI/skills/Evals/UseCases/<name>/config.yaml`:
...
Create `/home/postnl/PAI_Codex/Codex_PAI/skills/Evals/UseCases/<name>/prompts/v1.0.0.md`:
...
Create test cases in `/home/postnl/PAI_Codex/Codex_PAI/skills/Evals/UseCases/<name>/test-cases/`:
...
Create `/home/postnl/PAI_Codex/Codex_PAI/skills/Evals/UseCases/<name>/README.md`:
...
\`\`\`bash
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli-run.ts --use-case <name>
\`\`\`
...
```bash
# Check structure
ls -la /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/UseCases/<name>/

# Validate config
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli.ts use-case show <name>
```
...
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Evals/EvalServer/cli-run.ts \
  --use-case <name> \
  --test-id 001-basic \
  --verbose
```
