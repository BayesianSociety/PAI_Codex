...
## Examples Location
`/home/postnl/PAI_Codex/Codex_PAI/skills/Webassessment/webapp-examples/`
...
```bash
python /home/postnl/PAI_Codex/Codex_PAI/skills/Webassessment/webapp-scripts/with_server.py \
    --server "npm run dev" \
    --port 5173 \
    -- python my_test.py
```
...
- Web app testing guide: `/home/postnl/PAI_Codex/Codex_PAI/skills/Webassessment/Workflows/webapp/testing-guide.md`
- Server helper script: `/home/postnl/PAI_Codex/Codex_PAI/skills/Webassessment/webapp-scripts/with_server.py`
