...
export const CONFIG = {
  ...
  // Local paths
  paths: {
    root: '/home/postnl/PAI_Codex/Codex_PAI/skills/hacking/bug-bounties',
    state: '/home/postnl/PAI_Codex/Codex_PAI/skills/hacking/bug-bounties/state.json',
    cache: '/home/postnl/PAI_Codex/Codex_PAI/skills/hacking/bug-bounties/cache',
    logs: '/home/postnl/PAI_Codex/Codex_PAI/skills/hacking/bug-bounties/logs',
  },
