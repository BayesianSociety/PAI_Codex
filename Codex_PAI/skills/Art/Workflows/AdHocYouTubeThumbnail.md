...
```bash
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Art/Tools/Generate.ts \
...
bun /home/postnl/PAI_Codex/Codex_PAI/skills/Headshot/Tools/Headshot.ts \
  --prompt "[FACE-ONLY HEADSHOT PROMPT]" \
  --reference /home/postnl/PAI_Codex/Codex_PAI/skills/Headshot/Examples/reference.png \
  --reference /home/postnl/PAI_Codex/Codex_PAI/skills/Headshot/Examples/studio-glasses-style.png \
  --reference /home/postnl/PAI_Codex/Codex_PAI/skills/Headshot/Examples/clean-smile.png \
  --size 2K \
  --aspect-ratio 1:1 \
...
```bash
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/RemoveBg.ts ~/Downloads/yt-headshot-${TIMESTAMP}.png
```
...
```bash
bun /home/postnl/PAI_Codex/Codex_PAI/skills/Art/Tools/ComposeThumbnail.ts \
