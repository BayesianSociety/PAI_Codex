...
```bash
Read /home/postnl/PAI_Codex/Codex_PAI/skills/Art/SKILL.md
```
...
bun /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/Tools/RemoveBg.ts /path/to/output.png
...
**See:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Images/Workflows/BackgroundRemoval.md` for full documentation.
...
3. EMOTION → Match to register in /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/aesthetic.md
