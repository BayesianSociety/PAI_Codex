...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/Browser/`
...
**Headless by default.** All automation runs in headless mode. When the user says "show me" or wants to see what the assistant is seeing, open the URL in their preferred browser from `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TECHSTACKPREFERENCES.md`:
...
bun run /home/postnl/PAI_Codex/Codex_PAI/skills/Browser/Tools/Browse.ts https://example.com
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Browser/Tools/Browse.ts`
...
**Location:** `/home/postnl/PAI_Codex/Codex_PAI/skills/Browser/Tools/BrowserSession.ts`
...
```typescript
import { PlaywrightBrowser } from '/home/postnl/PAI_Codex/Codex_PAI/skills/Browser/index.ts'
