...
1. **Personal TELOS** - {PRINCIPAL.NAME}'s life context system (beliefs, goals, lessons, wisdom) at `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/` |
...
```
/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/
```
...
All files located in `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/`:
...
```bash
# View specific file
read /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/GOALS.md
read /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/BELIEFS.md

# View recent updates
read /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/updates.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/` (in the CORE USER directory)
