...
TELOS is {PRINCIPAL.NAME}'s life framework stored in `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/`. It contains:
...
!`FILE="$1"; CONTENT="$2"; DESCRIPTION="$3"; bun /home/postnl/PAI_Codex/Codex_PAI/commands/update-telos.ts "$FILE" "$CONTENT" "$DESCRIPTION"`
...
!`head -50 /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/updates.md`

## View Specific TELOS File
!`FILE="$1"; cat /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/"$FILE"`
...
Example:
```bash
bun /home/postnl/PAI_Codex/Codex_PAI/commands/update-telos.ts "BOOKS.md" "- *Project Hail Mary* by Andy Weir" "Added favorite book: Project Hail Mary"
```
...
The script is at: `/home/postnl/PAI_Codex/Codex_PAI/commands/update-telos.ts`

All backups are stored in: `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/Backups/`

All changes are logged in: `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/TELOS/updates.md`
