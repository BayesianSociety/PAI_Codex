...
```bash
cp -r /home/postnl/PAI_Codex/Codex_PAI/skills/telos/dashboard-template /path/to/your/project
...
- Searches `/home/postnl/PAI_Codex/Codex_PAI/skills/Telos/` for `.md` files
- Searches `/home/postnl/PAI_Codex/Codex_PAI/skills/Telos/data/` for `.csv` files
