...
const entityIndex = JSON.parse(
  fs.readFileSync('/home/postnl/PAI_Codex/Codex_PAI/skills/parser/entity-index.json', 'utf-8')
);
...
```typescript
import { scrapeAsMarkdown } from '/home/postnl/PAI_Codex/Codex_PAI/skills/mcp/Providers/brightdata/actors';
...
// Main processing
const entityIndexPath = '/home/postnl/PAI_Codex/Codex_PAI/skills/parser/entity-index.json';
...
const schema = JSON.parse(
  fs.readFileSync('/home/postnl/PAI_Codex/Codex_PAI/skills/parser/schema/content-schema.json', 'utf-8')
);
...
processedArticles.forEach((article: any, index: number) => {
  ...
  if (!valid) {
    ...
    const filename = `/home/postnl/PAI_Codex/Codex_PAI/skills/parser/output/${timestamp}_batch-${index + 1}.json`;
...
```bash
# Check entity counts
cat /home/postnl/PAI_Codex/Codex_PAI/skills/parser/entity-index.json | jq '{
