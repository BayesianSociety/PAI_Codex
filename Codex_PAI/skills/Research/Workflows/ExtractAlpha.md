...
```bash
/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/{current_work}/scratch/
```

**To get the current work directory:**
1. Read `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/current-work.json`
2. Extract the `work_dir` value
3. Use `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/{work_dir}/scratch/` for temporary artifacts
...
```
/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/20260111-172408_extract-alpha-analysis/scratch/
├── raw-transcript.txt
...
```bash
/home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_description/
```
...
```
/home/postnl/PAI_Codex/Codex_PAI/History/research/2025-10-26_podcast-analysis/
...
1. **Check if hooks captured the output:**
   ...
   ls -lt /home/postnl/PAI_Codex/Codex_PAI/History/research/ | head -5

   # Verify your research directory exists
   ls /home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_description/
   ```

2. **If hooks did NOT capture automatically:**
   ```bash
   # Create directory structure manually
   mkdir -p /home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_description/
...
3. **Confirm all files saved:**
   ```bash
   ls -lah /home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_description/
...
WORK_DIR=$(jq -r '.work_dir' /home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/current-work.json)

# 2. Create scratch workspace in current work item
mkdir -p /home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/${WORK_DIR}/scratch/
cd /home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/${WORK_DIR}/scratch/
...
mkdir -p /home/postnl/PAI_Codex/Codex_PAI/History/research/$(date +%Y-%m-%d)_podcast-analysis/
...
ls -lah /home/postnl/PAI_Codex/Codex_PAI/History/research/$(date +%Y-%m-%d)_podcast-analysis/
...
2. **Get current work directory** - Read `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/current-work.json` for `work_dir`
3. **Create scratch workspace** - Work in `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/{work_dir}/scratch/`
...
6. **Save to history** - Final outputs to `/home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM-DD_description/`
