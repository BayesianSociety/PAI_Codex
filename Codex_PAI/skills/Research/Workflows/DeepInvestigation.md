...
```
/home/postnl/PAI_Codex/Codex_PAI/MEMORY/RESEARCH/{YYYY-MM}/{YYYY-MM-DD}_{topic-slug}/
```

Read `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/current-work.json` for the active work directory. If a work item exists, also symlink the vault into `{work_dir}/scratch/research-vault/`.
...
Templates live at `/home/postnl/PAI_Codex/Codex_PAI/skills/Research/Templates/{DomainName}.md`
