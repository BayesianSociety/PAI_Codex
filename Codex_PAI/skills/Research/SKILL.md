...
`/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/Research/`
...
**Artifacts persist** at `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/RESEARCH/{date}_{topic}/` — the vault survives across sessions.
...
**Scratch (temporary work artifacts):** `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/WORK/{current_work}/scratch/`
- Read `/home/postnl/PAI_Codex/Codex_PAI/MEMORY/STATE/current-work.json` to get the `work_dir` value
...
**History (permanent):** `/home/postnl/PAI_Codex/Codex_PAI/History/research/YYYY-MM/YYYY-MM-DD_[topic]/`
