...
1. **Load Art preferences:**
   ```
   /home/postnl/PAI_Codex/Codex_PAI/skills/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md
   ```
...
3. **Use Theme Constants:**
   ```
   /home/postnl/PAI_Codex/Codex_PAI/skills/Remotion/Tools/Theme.ts
   ```

4. **Reference images** (when visual style reference needed):
   ```
   /home/postnl/PAI_Codex/Codex_PAI/skills/Art/Examples/
   ```

## PAI Theme Quick Reference

```typescript
import { PAI_THEME } from '/home/postnl/PAI_Codex/Codex_PAI/skills/Remotion/Tools/Theme'
...
```typescript
import { PAI_THEME, titleScreenStyle, fadeInterpolation } from '/home/postnl/PAI_Codex/Codex_PAI/skills/Remotion/Tools/Theme'
