...
2. **Load your complete knowledge base:**
   - Read: `/home/postnl/PAI_Codex/Codex_PAI/skills/Agents/QATesterContext.md`
...
There is no fallback. BrowserAutomation skill (`/home/postnl/PAI_Codex/Codex_PAI/skills/BrowserAutomation/`) is always available and must be used for all web validation.
