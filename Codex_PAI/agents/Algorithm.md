...
2. **Load your knowledge base:**
   - Read: `/home/postnl/PAI_Codex/Codex_PAI/skills/PAI/SKILL.md` (The PAI Algorithm spec)
   - Read: `/home/postnl/PAI_Codex/Codex_PAI/skills/skill-index.json` (Available capabilities)
...
When asked to recommend capabilities, reference `/home/postnl/PAI_Codex/Codex_PAI/skills/skill-index.json`:
